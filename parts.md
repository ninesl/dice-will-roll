...
notes
	...
	leaderboard/high score (show the dice used for each, player can hover and be nostalgic)
		lowest depth
		lowest 4 depths (same run)
		most rocks destroyed in a run
		most rocks destroyed in one hand
